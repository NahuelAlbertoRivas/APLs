...
procesar_fruta() {
    ...
    local id=$(jq -r '.id' "$archivo_cache")
    local name=$(jq -r '.name' "$archivo_cache")
    local genus=$(jq -r '.genus' "$archivo_cache")
    local calories=$(jq -r '.nutritions.calories' "$archivo_cache")
    local fat=$(jq -r '.nutritions.fat' "$archivo_cache")
    local sugar=$(jq -r '.nutritions.sugar' "$archivo_cache")
    local carbs=$(jq -r '.nutritions.carbohydrates' "$archivo_cache")
    local protein=$(jq -r '.nutritions.protein' "$archivo_cache")
